...
<security:authorize access="hasRole('ADMIN')">
	...
	<fieldset>
		...
		<display:table name="processionsIn30Days" id="procession">
					...
					<acme:column code="dashboard.procession.title" value="${ procession.title}"></acme:column>
					<acme:column code="dashboard.procession.momentOrganised" value="${ procession.momentOrganised}"></acme:column>	
