...
public class ConfigurationService {
	...
	public Configuration create() {
		...
		configuration.setLegalTextEN("1. What is personal data? " + "Personal Data is any information that makes it possible to identify or make identifiable a person. "
			...
			+ "In addition, when the website is used, certain information is automatically stored for technical reasons (e.g., the IP address assigned by the users Internet access provider)." + "2. What personal data is used and for what purpose?"
		...
		configuration.setLegalTextES("1. ¿Qué son datos personales?"
		...
		configuration.setCookiesTextEN("What is a cookie and what is it for?" + "A Cookie is a small file that is stored on the users computer, tablet, smartphone or any other device with information about navigation."
			...
			+ "Maintain a record of saved products." + "Conduct research and diagnostics to improve the content, products and services of Acme-Madrugá." + "Prevent fraudulent activities." + "Improve security."
			+ "Submit content, including advertisements, Acme-Madrugá and third-party pages that may be of interest to you." + "Inform. This allows us to consider and analyze the performance of our services."
		...
		configuration.setCookiesTextES("¿Qué es una cookie y para qué sirve?" + "Una Cookie es un pequeño archivo que se almacena en el ordenador del usuario, tablet, smartphone o cualquier otro dispositivo con información sobre la navegación."
			...
			+ "Mantener un registro de los productos guardados." + "Llevar a cabo investigaciones y diagnósticos para mejorar el contenido, los productos y los servicios de Acme-Madrugá." + "Prevenir actividades fraudulentas." + "Mejorar la seguridad."
			+ "Enviar contenidos, incluyendo anuncios, páginas de Acme-Madrugá y de terceros que podrían interesarte." + "Informar. Esto nos permite considerar y analizar el rendimiento de nuestros servicios."
